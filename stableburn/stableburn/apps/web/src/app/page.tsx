    ...
    <main className="min-h-screen bg-gray-50 relative">
      ...
      <div className="absolute top-4 right-4 z-50">
        <a
          ...
          className="pixel-card-blue p-3 flex items-center gap-2 text-white hover:scale-105 transition-all"
        >
        ...
        {!isAuthenticated ? (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-12">
              {/* Title Card - Smaller */}
              <div className="lg:col-span-1 pixel-card-blue p-6 flex items-center justify-center">
                <h1 className="text-lg lg:text-xl font-bold text-white text-center leading-tight">
                  Stableburn x402 Agent
                </h1>
              </div>
              
              {/* Main Hero Message - Wider */}
              <div className="lg:col-span-3 pixel-card-blue p-8 flex items-center justify-center">
                <h2 className="text-xl lg:text-2xl font-bold text-white text-center leading-relaxed">
                  Message agentprotocol.eth on the Base app for the MCP Bazaar, and simply pay .01 USDC for Opensea data
                </h2>
              </div>
            </div>
            ...
            <div className="mb-12">
              <div className="pixel-card-orange p-8">
                <div className="text-center mb-8">
                  <div className="flex items-center justify-center gap-4 mb-4">
                    ...
                    <a 
                      ...
                      className="pixel-card-green px-6 py-3 text-white font-bold text-lg hover:scale-105 transition-all"
                    >
                      BUY
                    </a>
                  </div>
              ...
              <div className="pixel-card p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-center">
                  <div>
                    ...
                    <div className="text-white/80 text-base font-medium">Initial MCap</div>
                  </div>
                  
                  <div>
                    <div className="text-3xl lg:text-4xl font-bold text-white mb-2">40.2B</div>
                    <div className="text-white/80 text-base font-medium">Tokens</div>
                  </div>
                  
                  <div>
                    <div className="text-3xl lg:text-4xl font-bold text-white mb-2">30min</div>
                    <div className="text-white/80 text-base font-medium">Fair Launch Window</div>
                  </div>
                  
                  <div>
                    <div className="text-3xl lg:text-4xl font-bold text-white mb-2">95%</div>
                    <div className="text-white/80 text-base font-medium">Available for Public</div>
                  </div>
                  
                  <div>
                    <div className="text-3xl lg:text-4xl font-bold text-white mb-2">95%</div>
                    <div className="text-white/80 text-base font-medium">Token Fees to Buybacks</div>
                  </div>
                </div>
                
                <div className="mt-8 text-center">
                  <p className="text-white/90 text-lg font-medium">
                    Automated through v4 uniswap hooks
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Roadmap Section */}
            <div className="mb-12">
              <div className="pixel-card-blue p-8">
                <div className="text-center mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-blue-400 flex items-center justify-center text-2xl mb-4 mx-auto" style={{imageRendering: 'pixelated'}}>
                      🎭
                    </div>
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-orange-400 flex items-center justify-center text-2xl mb-4 mx-auto" style={{imageRendering: 'pixelated'}}>
                      🌐
                    </div>
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-green-400 flex items-center justify-center text-2xl mb-4 mx-auto" style={{imageRendering: 'pixelated'}}>
                      🔍
                    </div>
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-purple-400 flex items-center justify-center text-2xl mb-4 mx-auto" style={{imageRendering: 'pixelated'}}>
                      📢
                    </div>
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-red-400 flex items-center justify-center text-2xl mb-4 mx-auto" style={{imageRendering: 'pixelated'}}>
                      ⚡
                    </div>
            ...
            <div className="mb-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Automated Buybacks */}
                <div className="pixel-card-blue p-6">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-blue-400 flex items-center justify-center" style={{imageRendering: 'pixelated'}}>
                ...
                <div className="pixel-card-orange p-6">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-16 h-16 bg-gray-800 border-2 border-orange-400 flex items-center justify-center" style={{imageRendering: 'pixelated'}}>
          ...
          <div className="text-center">
            <div className="pixel-card p-8 mb-8 max-w-2xl mx-auto">
